...
{
    /// <summary>
    /// This is a seperate class to reflect the actual response from api, 
    /// generated code seems to be not working
    /// Acutal class - LinearPositionListResultBase
    /// </summary>
    [DataContract]
    public class LinearPositionList
    {
          /// <summary>
        /// Initializes a new instance of the <see cref="LinearPositionList" /> class.
        /// </summary>
        ...
        public LinearPositionList(decimal? retCode = default(decimal?), string retMsg = default(string), string extCode = default(string), string extInfo = default(string), JToken result = default(JToken), string timeNow = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LinearPositionListResultBase {\n");
        ...
        {
            return this.Equals(input as LinearPositionListResultBase);
        }

        /// <summary>
        /// Returns true if LinearPositionListResultBase instances are equal
        /// </summary>
        /// <param name="input">Instance of LinearPositionListResultBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinearPositionList input)
        {
            if (input == null)
                return false;
        ...
        private IEnumerable<LinearPositionListResult> FromJArray(JArray ja)
        {
            ...
            return 
                items.Select(i => 
                {
                    ...
                    {
                        return jtoken.ToObject<LinearPositionListResult>();
                    } 
                    return i.ToObject<LinearPositionListResult>();
                })
                .Where(p => p != null && p.Size > 0);
        }

        public IEnumerable<LinearPositionListResult> GetResult() =>

            Result switch
            {
                JArray jarr => FromJArray(jarr),
                JObject jobj => new[] { jobj.ToObject<LinearPositionListResult>() },
                _ => Enumerable.Empty<LinearPositionListResult>(),
            };
    }
}
